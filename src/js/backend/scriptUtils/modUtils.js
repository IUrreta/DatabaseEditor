...
export function timeTravelWithData(dayNumber, extend = false) {
  ...
  `, [], 'singleRow');
    ...
    updateSeasonModTable("time-travel", 1);
}
...
export function changeDriverLineUps() {
    ...
    updateSeasonModTable("change-line-ups", 1);
...
export function changeStats() {
    ...
    updateSeasonModTable("change-stats", 1);
...
export function change2024Standings(mod = "2025") {
    ...
    if (mod === "2025") {
        updateSeasonModTable("change-cfd", 1);
    }
}
...
export function changeRaces(type) {
    if (!changes.Calendar || !Array.isArray(changes.Calendar)) {
        ...
        if (type === "Start2024" || type === "End2024") {
            ...
            END;`, [], 'run');
            updateSeasonModTable("change-calendar", 1);
        }
...
export function insertStaff2025() {
    ...
    changeBudgets();
    updateSeasonModTable("extra-drivers", 1);
}
...
export function removeFastestLap() {
    ...
    updateSeasonModTable("change-regulations", 1);
}

function updateSeasonModTable(edit, value) {
...
export function updatePerofmrnace2025() {
    ...
    updateSeasonModTable("change-performance", 1);
