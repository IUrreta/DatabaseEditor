Staff_PerformanceStats_StartOfMonth table
...
|----|-----|-----------------------------------------------------------------------|--------------|----------------|-----------|-----------|------------|
| 0  | 0   | [Staff_Enum_PerformanceStatTypes](enum/Staff_Enum_PerformanceStatTypes.md) | StatID       | Value          | RESTRICT  | CASCADE   | NONE       |
