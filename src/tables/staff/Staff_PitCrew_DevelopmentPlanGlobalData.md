...
|----|-----|-----------------------------------------------------------------------------------|----------------|----------------|-----------|-----------|------------|
| 0  | 0   | [Staff_Enum_PitCrewTrainingGlobalFocus](Staff_Enum_PitCrewTrainingGlobalFocus.md) | TrainingFocus  | Value          | RESTRICT  | CASCADE   | NONE       |
| 1  | 0   | [Staff_Enum_PitCrewTrainingPreset](Staff_Enum_PitCrewTrainingPreset.md)           | TrainingPreset | Value          | RESTRICT  | CASCADE   | NONE       |
