...
from scripts.edit_stats import edit_stats as run_editStats, edit_mentality, edit_superlicense, edit_freeze_mentality,edit_marketability, edit_retirement, edit_age, edit_name, edit_code
